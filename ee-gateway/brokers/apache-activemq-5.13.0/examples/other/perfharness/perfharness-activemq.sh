...
#
# It assumes that the apache-activemq-5.13.0.jar and 
...
java ${JAVA_OPTIONS} -cp ${ACTIVEMQ_HOME}/apache-activemq-5.13.0.jar:${PERFHARNESS_HOME}/perfharness.jar JMSPerfHarness -pc JNDI -ii org.apache.activemq.jndi.ActiveMQInitialContextFactory -iu $BROKER_URL -cf ConnectionFactory -d dynamic$DESTINATION $@